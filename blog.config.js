...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '洛辰凝', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '在构建梦幻的平行宇宙的神秘学探索者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fallenmiracle.us.kg/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'OC,神秘学', // 网站关键词 英文逗号隔开
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '5188101524', // 对应歌单的 id
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'NotionNext BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译=w=
  HOME_BANNER_IMAGE:
