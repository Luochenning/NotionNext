const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>在尝试和云朵共舞的梦游者<br/>一只破打游戏的、灵魂长期飘在异世界的‘寄居人’<br/>尝试触摸各种各样神秘学知识的神秘学探索者<br/>正在梦境和现实的交界处遨游中......</div>',
