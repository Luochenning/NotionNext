...
module.exports = {
  ...
  LATEST_POST_COUNT: process.env.NEXT_PUBLIC_LATEST_POST_COUNT || 0, // 最新文章数量
  ...
  ORIGINALITY_PROOF_AUTO_MANIFEST:
    process.env.ORIGINALITY_PROOF_AUTO_MANIFEST || 'true', // 原创存证：构建时自动生成 public/proofs/originality.json
